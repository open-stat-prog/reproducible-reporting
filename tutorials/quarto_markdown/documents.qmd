...
- [Example .qmd file](https://github.com/open-stat-prog/reproducible-reporting/blob/main/assets/docs/presentation_example.qmd)
- [Resuling .html output file](https://github.com/open-stat-prog/reproducible-reporting/blob/main/docs/assets/docs/presentation_example.html)
